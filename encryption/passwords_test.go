...
func TestBuildSecret(t *testing.T) {
	testCases := []struct {
		...
		{
			username: "Alice",
			secret:   []byte{0x41, 0x6c, 0x69, 0x63, 0x65, 0x35, 0x42, 0x55, 0x70, 0x74, 0x61, 0x4d, 0x70, 0x6b, 0x6f, 0x70, 0x61, 0x6d, 0x66, 0x6a, 0x52, 0x65, 0x35, 0x6d, 0x62, 0x53, 0x53, 0x4e, 0x64, 0x73, 0x2b, 0x55},
		},
		{
			username: "Bob",
			secret:   []byte{0x42, 0x6f, 0x62, 0x35, 0x42, 0x55, 0x70, 0x74, 0x61, 0x4d, 0x70, 0x6b, 0x6f, 0x70, 0x61, 0x6d, 0x66, 0x6a, 0x52, 0x65, 0x35, 0x6d, 0x62, 0x53, 0x53, 0x4e, 0x64, 0x73, 0x2b, 0x55, 0x30, 0x57},
		},
	}
